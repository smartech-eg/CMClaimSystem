/*
Generic confirmation dialog used in all confirmations appears in the application
Passing to it the confirmation message and the action to be applied when the user confirms
*/
...
function(declare, Dialog){
	return declare("com.rsca.nv.esos.widgets.mainWidget.ConfirmDialog", Dialog, {
